...
import com.stacktrace.yo.dagen.igdb.pipeline.detail.actor.GameDetailSupervisor.{SendNextRequests, WriteNextObjects}
import com.stacktrace.yo.dagen.igdb.pipeline.detail.actor.WriteGameDetailActor.{FinishedWrite, WriteGame}
import com.stacktrace.yo.dagen.old.core.Protocol.{PipelineFinished, Report, StartDelegate, Working}
import com.stacktrace.yo.dagen.old.core.pipeline.Delegator
