package com.stacktrace.yo.dagen.igdb.engine

import akka.actor.{Actor, ActorLogging, ActorRef, Cancellable, Props}
import com.stacktrace.yo.dagen.igdb.pipeline.detail.GameDetailPipeline
import com.stacktrace.yo.dagen.igdb.pipeline.extract.GameDetailExtractionPipeline
import com.stacktrace.yo.dagen.igdb.pipeline.list.GameListPipeline
