...
import com.stacktrace.yo.dagen.igdb.pipeline.extract.actor.GameDataExtractionDelegate.{Process, ProcessObjects, Processed, ReadNextFile}
import com.stacktrace.yo.dagen.old.core.Protocol.{Report, StartDelegate, Working}
